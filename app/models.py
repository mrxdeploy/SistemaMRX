...
class OrdemCompra(db.Model):  # type: ignore
    ...
    def to_dict(self):
        return {
            ...
            'fornecedor_id': self.fornecedor_id,
            'fornecedor_nome': self.fornecedor.nome if self.fornecedor else None,
            'fornecedor_cnpj': self.fornecedor.cnpj if self.fornecedor else None,
            'fornecedor_cpf': self.fornecedor.cpf if self.fornecedor else None,
            'fornecedor_tipo_documento': self.fornecedor.tipo_documento if self.fornecedor else None,
